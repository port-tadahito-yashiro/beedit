...
class Project < ActiveRecord::Base
  ...
  def self.regist(params)
    ...
    project.thanks_title       = params[:thanks_title]
    project.thanks_text        = params[:thanks_text]
    project.mail_title         = params[:mail_title]
    project.mail_text          = params[:mail_text]
    project.personal_info      = params[:personal_info]
